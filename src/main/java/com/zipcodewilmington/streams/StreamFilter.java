...
public class StreamFilter {
    ...
    public List<Person> toListOneLine() {
        ...
        return personStream.filter(person -> person.getName().startsWith(startingCharacter)).filter(person -> person.getName().endsWith(startingCharacter)).collect(Collectors.toList());
    }
